...
public final class FragmentThreeBinding implements ViewBinding {
  ...
  public static FragmentThreeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment__three, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentThreeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentThreeBinding((ConstraintLayout) rootView, indicatorLayout, lavActionBar,
